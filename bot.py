...
def setup_deno():
    ...
    possible_paths = [
        ...
        os.path.join(os.getcwd(), ".deno"),
        os.path.expanduser("~/.deno/bin"),
        "/opt/render/project/src/.deno/bin",
        "/opt/render/project/src/.deno",
    ]
...
def download_youtube_audio(query):
    ...
    ydl_opts = {
        ...
        # Current yt-dlp YouTube EJS setup
        "remote_components": {
            "ejs": "github"
        },
    }
